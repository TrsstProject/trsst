 ...
 */
public class AnonymSSLSocketFactory implements SecureProtocolSocketFactory {
    ...
    /*
     * @see
     * ProtocolSocketFactory#createSocket(java.lang.String,int,java.net.InetAddress
     * ,int)
     */
